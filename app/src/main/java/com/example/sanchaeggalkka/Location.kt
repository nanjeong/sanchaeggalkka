...
class Location : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinnerSuper.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                when (spinnerSuper.getItemAtPosition(position)) {
                    ...
                    "이어도" -> setSigunguAdapter(R.array.mu)
                    else -> setSigunguAdapter(R.array.mu)
                }
            }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val district = db.districtDatabaseDao.getAll()
                ...
                override fun onItemSelected(
                    ...
                    when (selectedDistrict[0]) {
                        ...
                        "제주특별자치도" -> {
                            ...
                            selectedDistrict[1] = ""
                            selectedDistrict[2] = ""
                            setDongAdapter(3772, 3772, district)
                        }
                    }
                }
    ...
    private fun setDongAdapter(start: Int, end: Int, district: List<AdministrativeDistrict>) {
        ...
        dongArray.add("읍/면/동")
        district.slice(start..end).forEach {
            dongArray.add(it.name3)
        }
